...
export const caseStudies: CaseStudy[] = [
	{
		slug: 'the-burlington-portfolio-westlake-apartments',
		title: 'The Burlington Portfolio',
		location: 'Westlake/MacArthur Park, Los Angeles, CA',
		submarket: 'westlake',
		summary: 'A 192-unit, three-building Westlake portfolio sold under new statewide rent control, exchanged into two Texas multifamily assets across state lines.',
		dealType: ['1031'],
		opportunity:
		...
		images: ['/images/listings/131-171-s-burlington-ave-los-angeles-ca-90057/the-burlington-portfolio-los-angeles-ca-1.webp'],
	},
	{
		...
		images: ['/images/listings/941-n-normandie-ave-los-angeles-ca-90029/941-n-normandie-ave-los-angeles-ca.webp'],
	},
	{
		slug: '925-n-san-vicente-blvd-west-hollywood-apartments',
		title: '925 N San Vicente Blvd',
		location: 'West Hollywood, CA',
		submarket: null,
		summary: 'A rent-controlled 9-unit West Hollywood building facing seismic retrofit requirements went under contract in under a week.',
		dealType: ['value-add'],
		opportunity:
		...
		images: ['/images/listings/925-n-san-vicente-blvd-west-hollywood-ca-90069/925-n-san-vicente-blvd-west-hollywood-ca.webp'],
	},
	{
		slug: '6938-coldwater-canyon-ave-north-hollywood-apartments',
		title: '6938 Coldwater Canyon Ave',
		location: 'North Hollywood, CA',
		submarket: 'north-hollywood',
		summary: 'A soft-story, rent-controlled North Hollywood building drew over 15 offers in its first week and closed above asking.',
		dealType: ['value-add'],
		opportunity:
	...
	{
		slug: '467-s-bonnie-brae-st-westlake-apartments',
		title: '467 S Bonnie Brae St',
		location: 'Westlake/MacArthur Park, Los Angeles, CA',
		submarket: 'westlake',
		summary: 'An 18-unit non-rent-controlled Westlake asset with elevated operating costs drew multiple offers within a week.',
		dealType: ['value-add'],
		opportunity:
	...
	{
		slug: '3148-james-m-wood-blvd-koreatown-apartments',
	...
	{
		slug: '2429-cheremoya-ave-beachwood-canyon-apartments',
		title: '2429 Cheremoya Ave',
		location: 'Beachwood Canyon, Hollywood Hills, CA',
		submarket: null,
		summary: 'A stabilized 7-unit Beachwood Canyon building that had stalled with another brokerage sold above its prior list price.',
		dealType: ['value-add'],
		opportunity:
	...
	{
		slug: '140-westmoreland-ave-koreatown-apartments',
		title: '140 S Westmoreland Ave',
		location: 'Virgil / Downtown-adjacent, Los Angeles, CA',
		submarket: 'koreatown',
		summary: 'Buyer representation on a core-plus Koreatown-area asset in an up-and-coming submarket, secured through early access and market insight.',
		dealType: ['buyer-rep'],
		opportunity:
	...
	{
		slug: '11667-goshen-ave-brentwood-apartments',
	...
	{
		slug: '11642-kiowa-ave-brentwood-apartments',
		...
		images: ['/images/listings/11642-kiowa-ave-los-angeles-ca-90049/11642-kiowa-ave-los-angeles-ca.webp'],
	},
	{
		slug: '1201-s-orange-grove-ave-mid-wilshire-apartments',
	...
	{
		slug: '236-s-bonnie-brae-st-westlake-apartments',
		title: '236 S Bonnie Brae St',
		location: 'Westlake/MacArthur Park, Los Angeles, CA',
		submarket: 'westlake',
		summary: 'A large, off-market sale of a 65-unit Westlake building leveraged a proven repeat buyer to move past deferred-maintenance objections.',
		dealType: ['value-add'],
		opportunity:
	...
	{
		slug: '453-s-gramercy-pl-koreatown-apartments',
		title: '453 S Gramercy Pl',
		location: 'Western Koreatown / Hancock Park, Los Angeles, CA',
		submarket: 'koreatown',
		summary: 'A 14-unit Koreatown building with long-term, below-market tenants sold off-market to a buyer that assumed the soft-story retrofit.',
		dealType: ['value-add'],
		opportunity:
	...
	{
		slug: '5455-inglewood-blvd-culver-city-apartments',
		title: '5455 Inglewood Blvd',
		location: 'Culver City, CA (Playa Vista-adjacent)',
		submarket: null,
		summary: 'Buyer representation on an off-market, newly built 13-unit Culver City asset near Silicon Beach, closed with certainty via a pre-close lease-up.',
		dealType: ['buyer-rep'],
		opportunity:
	...
	},
	{
		...
		opportunity:
			'1513 Arlington Ave is a 9-unit apartment building in Arlington Heights. We generally advise our sellers against spending money on their property before a sale, since sellers historically see little return on that investment from buyers. Investors targeting RSO buildings, especially ones with below-market tenants and deferred maintenance, typically bring their own value-add plan and the experience to bring a property up to market more cost effectively than a seller can. Following that approach, our selling client did not want to fund two costly items before close: replacing the property’s Federal Pacific electrical sub-panels, which insurers are increasingly requiring owners to replace, and completing the SB 721 inspection of its two exterior balconies, a state-mandated safety inspection of balconies, decks, stairways, and walkways on multifamily buildings with three or more units.',
		solution:
			'We hosted an open house so brokers, their clients, and buyers from our own database could walk the vacant units and see the opportunity firsthand. The listing drew offers from 12 individual buyers. In negotiating the counter offers, we made sure every buyer in contention agreed to take on both the electrical sub-panel replacement and the SB 721 inspection after close of escrow, keeping those costs off our seller’s side of the ledger. The winning buyer came from our own database, a seasoned investor experienced operating RSO buildings across LA. We coordinated closely with our seller’s 1031 exchange team throughout escrow.',
		results:
